...
set_property is_locked true [get_files D:/Development/FPGA/InterNoC/InterNoC.srcs/sources_1/bd/DemoInterconnect/ip/DemoInterconnect_axi_spi_master_1_1/DemoInterconnect_axi_spi_master_1_1.xci]
...
synth_design -top DemoInterconnect_axi_spi_master_1_1 -part xc7a35tfgg484-2 -mode out_of_context

#---------------------------------------------------------
# Generate Checkpoint/Stub/Simulation Files For IP Cache
#---------------------------------------------------------
catch {
 write_checkpoint -force -noxdef -rename_prefix DemoInterconnect_axi_spi_master_1_1_ DemoInterconnect_axi_spi_master_1_1.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ DemoInterconnect_axi_spi_master_1_1_stub.v
 lappend ipCachedFiles DemoInterconnect_axi_spi_master_1_1_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ DemoInterconnect_axi_spi_master_1_1_stub.vhdl
 lappend ipCachedFiles DemoInterconnect_axi_spi_master_1_1_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ DemoInterconnect_axi_spi_master_1_1_sim_netlist.v
 lappend ipCachedFiles DemoInterconnect_axi_spi_master_1_1_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ DemoInterconnect_axi_spi_master_1_1_sim_netlist.vhdl
 lappend ipCachedFiles DemoInterconnect_axi_spi_master_1_1_sim_netlist.vhdl

 config_ip_cache -add -dcp DemoInterconnect_axi_spi_master_1_1.dcp -move_files $ipCachedFiles -use_project_ipc -ip [get_ips DemoInterconnect_axi_spi_master_1_1]
}

rename_ref -prefix_all DemoInterconnect_axi_spi_master_1_1_

write_checkpoint -force -noxdef DemoInterconnect_axi_spi_master_1_1.dcp

catch { report_utilization -file DemoInterconnect_axi_spi_master_1_1_utilization_synth.rpt -pb DemoInterconnect_axi_spi_master_1_1_utilization_synth.pb }
