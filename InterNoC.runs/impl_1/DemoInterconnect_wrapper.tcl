...
set rc [catch {
  ...
  catch { write_sysdef -hwdef DemoInterconnect_wrapper.hwdef -bitfile DemoInterconnect_wrapper.bit -meminfo DemoInterconnect_wrapper.mmi -file DemoInterconnect_wrapper.sysdef }
  catch {write_debug_probes -quiet -force DemoInterconnect_wrapper}
  catch {file copy -force DemoInterconnect_wrapper.ltx debug_nets.ltx}
